...
#if DT_INST_PROP(0, size_in_bytes) && DT_INST_PROP(0, size)
#error "'size' and 'size-in-bytes' is set. Only 'size-in-bytes should be set"
#endif
#if DT_INST_PROP(0, size_in_bytes)
#define INST_0_BYTES (DT_INST_PROP(0, size_in_bytes))
#elif DT_INST_PROP(0, size)
#define INST_0_BYTES (DT_INST_PROP(0, size) / 8)
#else
#error "No size specified. 'size-in-bytes' must be set"
#endif
